...
Projeto Kotlin Android do livro "Desenvolvedor Kotlin Android - Bibliotecas para o dia a dia". Projeto apresentado na Parte I do livro, mais precisamente no terceiro capítulo "Destrinchando as intenções de mapas".
...
**Obs. 1:** para o total entendimento do projeto é preciso ter e mãos o livro "Desenvolvedor Kotlin Android" com o capítulo 3 já aberto, pois as explicações detalhadas estarão nesta seção do livro.
...
"Desenvolvedor Kotlin Android" - 1ª edição
